...
{
    ui->setupUi(this);
    ui->key->setValidator(new QIntValidator());
    ui->findKey->setValidator(new QIntValidator());
    ui->setKey->setValidator(new QIntValidator());
    ui->setValue->setValidator(new QIntValidator());
    ui->value->setValidator(new QIntValidator());
}
...
void MainWindow::on_pushButton_clicked()
{
    ...
    pair<int,int> tmp(ui->key->text().toInt(),ui->value->text().toInt());
